clear all
close all
path_p=['/mnt/Shared_Data/anic/10-27-21/Pure_polypropylene/']; %%%Change for polymer
prefix_p=['Polypropylene_'];%%%Change for polymer
path_b=['/mnt/Shared_Data/anic/10-03-21/AP/']; %%%Change for binder
prefix_b=['Asphaltene_phenol_poly_'];%%%Change for binder
path_mix=['/mnt/Shared_Data/anic/10-27-21/Polypropylene_mix/Polypropylene_mix/Asphaltene_phenol_propylene/']; %%%Change for mix
...
for tstart=600;  %for new molecules pure
