TypeMAT=[16    16    52    44    16    16    60    20    16    12    12     8     0     0     0     0     0     0     0]*4*6
TypeMAT(18)=4*6;
% TypeMAT(17)=2;
...
BoxSize=[100 100 100]*10
DegreeofPolymerization=[400 262 204 106]; %PE PP PB PS 
SBSDegreeOfPolymerization=[26 102 26]; %SBS
...
Molecules={'Squalane','Hopane','DOCHN','PHPN','Quinolinohopane','Pyridinohopane','Benzobisbenzothiophene','Trimethylbenzene-oxane','Thio-Isorenieratane','Asphaltene Thiophene','Asphaltene Phenol','Asphaltene Pyrrole','Heptane','PE','PP','PB','PS','SBS','SBSr'};
...
Namelist={'SQ','HP','DCN','PHPN','QH','PH','BZB','TBO','TIR','AT','AP','APy','HEP','PE','PP','PB','PS','SBS','SBSr'};

for j=1:19 %1 = squalane 2=hopane 3=dochn 4=phpn 5= quinolinohopane 6=pyrodinohopane 7=BZB 8 = TBO 9=TIR 10=Asphaltene Thiophene (AT) 11=AP 12= APy 13 = Heptane 14 = PE 15 = PP 16 = PB 17 = PS 18 = SBS 19 = SBSr
...
attypelistcell={'RC1','RC2','RC3','RC4','RC5','SC1','SC2','SC3','SC4','SC5','SC6','TC1','TC2','TC3','TC4','TC5','TC5e','TC6','SN3a','SN4a','ATA','ATB','ATS','APA','APB','APO','ApA','ApB','ApN'};
system.attypelistcell=attypelistcell;
masslist=[72 72 72 72 72 54 54 54 54 54 54 36 36 36 36 36 36 36 54 54 36 36 36 36 36 36 36 36 36];
for i=1:length(system.attype)
    system.attypenum(i)=find(strcmp(attypelistcell,system.attype{i}));
end
system.mass=masslist';
Write_LAMMPS_Data(system,'test.data')
...
for i=21:29
    for j=21:29
        if j>=i
            size1=AsphaltSigmas(i-20);
            size2=AsphaltSigmas(j-20);
            sig=(size1+size2)/2;
            eps1=AsphaltEpsilons(i-20);
            eps2=AsphaltEpsilons(j-20);
            eps=sqrt(eps1*eps2);
            sig=sig;
            eps=eps;
...
attypelistcell={'RC1','RC2','RC3','RC4','RC5','SC1','SC2','SC3','SC4','SC5','SC6','TC1','TC2','TC3','TC4','TC5','TC5e','TC6','SN3a','SN4a'};
...
Table1Axis={'P6','P5','P4','P3','P2','P1','N6','N5','N4','N3','N2','N1','C6','C5','C4','C3','C2','C1'};
        ...
        elseif strcmp(L,'eo')
            level=level-1;
        elseif strcmp(L,'oo') || strcmp(L,'ao')
        else
            error('check labels')
        end
