...
fid = fopen('/mnt/Shared_Data/anic/LONI_output/New_files/Kspace_pppm_long/CGing/Asphalt_run/SQ_64/tmp.profile', 'r');
fgetl(fid);
fgetl(fid);
fgetl(fid);
%fgetl(fid);
...
fid = fopen('/mnt/Shared_Data/anic/LONI_output/New_files/Kspace_pppm_long/CGing/Asphalt_run/SQ_128/tmp.profile', 'r');
fgetl(fid);
fgetl(fid);
fgetl(fid);
%fgetl(fid);
...
fid = fopen('/mnt/Shared_Data/anic/LONI_output/New_files/Kspace_pppm_long/CGing/Asphalt_run/SQ_256/tmp.profile', 'r');
fgetl(fid);
fgetl(fid);
fgetl(fid);
%fgetl(fid);
...
% i=counter;
 ...
 fid = fopen('/mnt/Shared_Data/anic/LONI_output/New_files/Kspace_pppm_long/CGing/Asphalt_run/SQ_512/tmp.profile', 'r');
fgetl(fid);
fgetl(fid);
fgetl(fid);
%fgetl(fid);
