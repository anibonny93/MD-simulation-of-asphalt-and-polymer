...
path_p='/mnt/Shared_Data/anic/LONI_output/New_files/Kspace_pppm_long/2025/Oxidation_location/PE30/PE30_'; %%%Change for polymer

path_b='/mnt/Shared_Data/anic/LONI_output/New_files/Kspace_pppm_long/2024/Oxidized_asphalt_components/Oxidized_TIR/TIR_oxi_d1/TIR_oxi_d1_'; %%%Change for binder

path_mix='/mnt/Shared_Data/anic/LONI_output/New_files/Kspace_pppm_long/2024/Oxidized_asphalt_PE_2024/TIR_PE/TIR_PE30_oxi_d01/TIR_PE30_oxi_d01_'; %%%Change for mix

rep=256;%input('Enter replication number:')
mpm=30;%input('Enter monomer per molecule for polymer:')
