...
%data=B;
figure
plot(1-B_1(:,1),B_1(:,2), 1-B_2(:,1),B_2(:,2), 1-B_3(:,1),B_3(:,2), 1-B_4(:,1),B_4(:,2), '-')
colormap([0 0 0; 1 0 0; 0 1 0; 0 0 1]);
%plot(1-B_1(:,1),B_1(:,2),'-')
hold on 
xlabel('Monomer mole fraction')
        ylabel('Temperature (K)')
        legtext={'Polyethylene','Polypropylene','Polybutadiene','Polystyrene'}
        ...
        leg.Position=leg.Position
         export_fig 'bindoal_test_2' -png -r1-a4
